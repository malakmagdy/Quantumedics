...
import com.example.qproject.databinding.UploadBrainImageBinding
...
class UploadBrainActivity : AppCompatActivity() {
    private lateinit var binding: UploadBrainImageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = UploadBrainImageBinding.inflate(layoutInflater)
        ...
        binding.btnGetResults.setOnClickListener {
            ...
            val model = QuantumMRI.newInstance(this)
 ...
 */
            ...
            if (selectedImageUri != null) {
                ...
                //i.putExtra("diagnosisResult", diagnosisResult)
            ...
            lifecycleScope.launch {
                ...
                if (firstClass == "Yes"){
                    i.putExtra("yes_or_no", "Brain Tumor Detected")

                } else if (firstClass == "No"){
                    i.putExtra("yes_or_no", "Brain Tumor Free")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 100 && resultCode == Activity.RESULT_OK) {
            ...
            if (selectedImageUri != null) {
                binding.btnGetResults.visibility =
                    View.VISIBLE   // Image was uploaded, show the "Submit" button
                binding.ivBrain.setImageURI(selectedImageUri)   // Load the selected image into the ImageView
        ...
        // Request code = 200 means we request to  open camera
            ...
            if (capturedImageBitmap != null) {
                binding.ivBrain.setImageBitmap(capturedImageBitmap)     //change image to captured image
    ...
    private suspend fun fetchClassDescription(predictedClass: String): String {
        return withContext(Dispatchers.IO) {
            ...
            if (predictedClass == "Yes"){
                content = "what the patient should do if he/she diagnosed as Brain Tumor? Write this in 5 points each point no more than 3 lines"
            } else if (predictedClass == "No"){
                content = "what the patient should do to protect themselves from Brain Tumor? Write this in 5 points each point no more than 3 lines"
            }
                ...
                mapOf(
                    ...
                    "messages" to listOf(
                        mapOf(
                            "role" to "user",
                            "content" to content
                            //"content" to "what the patient should do if he/she diagnosed as MRI cancer? $predictedClass. write this in 5 points each point no more than 3 lines. If no write how to protect themselves."
                        )
                    )
                )
