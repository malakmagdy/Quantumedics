...
import com.example.qproject.databinding.UploadChestBinding
import com.example.qproject.ml.Pneumonia
...
class UploadChestActivity : AppCompatActivity() {
    private lateinit var binding: UploadChestBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = UploadChestBinding.inflate(layoutInflater)
        ...
        binding.btnGetResults.setOnClickListener {
            ...
            val model = Pneumonia.newInstance(this)
            ...
            lifecycleScope.launch {
                ...
                if (firstClass == "Yes"){
                    i.putExtra("yes_or_no", "Pneumonia Detected")

                } else if (firstClass == "No"){
                    i.putExtra("yes_or_no", "Pneumonia Free")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 100 && resultCode == Activity.RESULT_OK) {
            ...
            if (selectedImageUri != null) {
                ...
                binding.ivChest.setImageURI(selectedImageUri)   // Load the selected image into the ImageView
        ...
        // Request code = 200 means we request to  open camera
            ...
            if (capturedImageBitmap != null){
                binding.ivChest.setImageBitmap(capturedImageBitmap)     //change image to captured image
    ...
    private suspend fun fetchClassDescription(predictedClass: String): String {
        return withContext(Dispatchers.IO) {
            ...
            if (predictedClass == "Yes"){
                content = "what the patient should do if he/she diagnosed as Chest pneumonia? Write this in 5 points each point no more than 3 lines"
            } else if (predictedClass == "No"){
                content = "what the patient should do to protect themselves from Chest pneumonia? Write this in 5 points each point no more than 3 lines"
            }
                ...
                mapOf(
                    ...
                    "messages" to listOf(
                        mapOf(
                            "role" to "user",
                            "content" to content
                            //"content" to "what the patient should do if he/she diagnosed as Chest pneumonia? $predictedClass. write this in 5 points each point no more than two lines. If no write how to protect themselves."
